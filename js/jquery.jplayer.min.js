...
(function(b, f) {
    ...
    b.jPlayer.prototype =
		    ...
		    $("#jp-volume-percent").text(Number(parseFloat(a) * 100).toString() + "%");
                        ...
                        case "fullScreen":
                            if (this.options[a] !== c) {
                                ...
                                if (!e || e && !this.status.waitForPlay)
                                    e || (this.options[a] = c), c ? this._requestFullscreen() : this._exitFullscreen(),
			...
			default:
                ...
                _updateSize: function() {
                    ...
                    try {
                        if ("object" === typeof d.seekable && 0 < d.seekable.length)
                            d.currentTime = a * d.seekable.end(d.seekable.length -
                                    1) / 100;
                ...
                _flash_mute: function(a) {
                    ...
                    if (window.ActiveXObject)
                        ...
                        navigator.plugins && 0 < navigator.mimeTypes.length && (b = navigator.plugins["Shockwave Flash"]) && (a = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/,
                                "$1"));
                    return 1 * a
